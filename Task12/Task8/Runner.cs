...
namespace Task8
{
    ...
    {
        private readonly IGetStudentInfoService _studentInfoService;
        private readonly IInfoStringFormatter _fullInfoService;
        private readonly IInfoStringFormatter _lastNameService;
        public Runner(IGetStudentInfoService studentInfoService, GetFullInfoService fullInfoService, GetLastNameService lastNameService)
        {
